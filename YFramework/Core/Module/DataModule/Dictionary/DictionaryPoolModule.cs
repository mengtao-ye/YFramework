...
namespace YFramework
{
    ...
    /// 数据模块
    /// </summary>
    public static class DictionaryPoolModule<TKey, TData> where TData : IPool
    {
        ...
        {
            mAssetDict.Foreach(AssetForeach);
            mAssetDict.Clear();
        }
        private static void AssetForeach(TKey key, TData data)
        {
            data?.Recycle();
        }
    }
